...
@Morph(from = [SourceForTargetWithNoOverlappingNullability::class])
data class TargetHasNoOverlappingNullability(val a: String, val b: Int, val c: Double)
...
data class SourceForTargetWithNoOverlappingNullability(val a: String?, val b: Int?, val c: Double?)